  ...
  return (
    <View className="mt-6 rounded-card border border-line dark:border-line-dark bg-surface dark:bg-surface-dark p-5">
      <View className="mb-4 flex-row items-center gap-2">
        ...
        <Text className="font-display text-xl text-ink dark:text-ink-dark">Recent activity</Text>
      </View>
      ...
      <View className="gap-2">
        {activities.slice(0, maxItems).map((ev, i) => (
          <View
            ...
            className="flex-row items-center gap-3 rounded-xl bg-canvas dark:bg-canvas-dark px-3 py-2"
          >
